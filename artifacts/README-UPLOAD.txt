...
2) sol-beautiful-products.csv  ← Products → Import
...
B. Catalog
--------------------------------
1. Products → Import → upload sol-beautiful-products.csv.
2. Overwrite products with the same handle if you re-import.
3. Photos load from the listing image URLs. A large import takes several minutes.
...
Shopify CLI / GitHub is not required.
